    ...
    with container3:
        ...
        with container6:
            with col15:
                ...
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(6) > div.st-emotion-cache-115gedg.e1f1d6gn3 > div > div > div > div:nth-child(1) > div > div > div
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
