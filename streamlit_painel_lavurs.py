...
with container1:
    ...
    with col1:
        ...
        st.write('</div>', unsafe_allow_html=True)
    with col2:
        st.markdown(f'<h1 style="text-align: center;color:#000000;font-size:40px;margin-top:0px;margin-bottom:0px;">{"PAINEL DE DESASTRES DA BACIA HIDROGRÁFICA DO RIO DOS SINOS"}</h1>', unsafe_allow_html=True)    
        st.markdown(f'<h1 style="text-align: center;color:#000000;font-size:20px;margin-top:0px;margin-bottom:0px;">{"LABORATÓRIO DE VULNERABILIDADES, RISCOS E SOCIEDADE | OFICINA DE DEFESA CIVIL DO VALE DO PARANHANA"}</h1>', unsafe_allow_html=True)
        st.markdown(f'<h1 style="text-align: center;color:#000000;font-size:20px;margin-top:0px;margin-bottom:0px;">{f"RELATÓRIO ATUALIZADO EM TEMPO REAL"}</h1>', unsafe_allow_html=True)
