...
if page=="Painel LaVuRS":
    ...
    with container_filtros:
        ...
        {{
            background: linear-gradient(to bottom, #66b366 0%, #66b366 5%, #80cc80 10%, #99e599 15%, #b3e5c0 20%, white 50%);
    ...
    with container3:
        ...
        """
        <style>
        #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(2) > div > div
        {    
            box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
            border: 2px solid green;
            border-radius: 15px;
        ...
        with container4:
            with col11:
                ...
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(4) > div.st-emotion-cache-n4b52j.e1f1d6gn3
                {
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
            ...
            with col12:
                ...
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(4) > div.st-emotion-cache-1wce3lb.e1f1d6gn3
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
        ...
        with container5:
            ...
            with col13:
                ...
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(5) > div:nth-child(1) > div > div > div
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
            ...
            with col14:
                ...
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(5) > div:nth-child(2)
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
        ...
        with container6:
            with col15:
                ...
                """
                <style>
               #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(6) > div.st-emotion-cache-115gedg.e1f1d6gn3 > div > div > div
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
        ...
        with col16:
            ...
            st.markdown(
                """
                <style>
                #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-bm2z3a.ea3mdgi8 > div.block-container.st-emotion-cache-1jicfl2.ea3mdgi5 > div > div > div > div:nth-child(9) > div > div > div:nth-child(6) > div.st-emotion-cache-1r6slb0.e1f1d6gn3 > div > div > div > div:nth-child(1) > div > div > div
                {                
                    box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                    border: 2px solid green;
                    border-radius: 15px;
        ...
        with container7:
            ...
            df_final_municipios_atingidos = pd.DataFrame(index=eventos, columns=['Municipio mais atingido Alto Sinos', '% de Ocorrência Alto Sinos',
                                                                                 ...
                                                                                 'Municipio mais atingido Baixo Sinos', '% de Ocorrência Baixo Sinos'])
            
            for evento in eventos:
                for regiao in regioes:
                    temp = municipio_mais_atingido[(municipio_mais_atingido['Evento'] == evento) & (municipio_mais_atingido['Regiao_BHRS'] == regiao)]
                    if not temp.empty:
