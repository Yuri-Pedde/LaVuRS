...
if page=="Painel LaVuRS":
    ...
    with container2:
        ...
        with col5:
            ...
            """
            <style>
            #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-uf99v8.ea3mdgi5 > div.block-container.st-emotion-cache-z5fcl4.ea3mdgi4 > div > div > div:nth-child(4) > div > div.st-emotion-cache-ocqkz7.e1f1d6gn4 > div.st-emotion-cache-18fuwiq.e1f1d6gn2 {            
                box-shadow: 0px 0px 5px 5px rgba(0, 0, 0, 0.25);
                border: 2px solid green;
                border-radius: 15px;
                overflow: hidden;
